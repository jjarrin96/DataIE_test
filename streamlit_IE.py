...
# Datos cargados
df_ventas = pd.read_excel("v_py.xlsx", sheet_name="M")
df_ventas.set_index(df_ventas.columns[0], inplace=True)

df_empresas = pd.read_excel("ranking.xlsx")
...
cp_s1 = pd.read_excel("f_cp.xlsx", sheet_name="Intervalo bajo")
cp_s2 = pd.read_excel("f_cp.xlsx", sheet_name="Intervalo medio")
cp_s3 = pd.read_excel("f_cp.xlsx", sheet_name="Intervalo alto")
...
lp_s1 = pd.read_excel("f_lp.xlsx", sheet_name="Intervalo bajo")
lp_s2 = pd.read_excel("f_lp.xlsx", sheet_name="Intervalo medio")
lp_s3 = pd.read_excel("f_lp.xlsx", sheet_name="Intervalo alto")
